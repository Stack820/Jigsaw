module fairui {
    ...
    export class BasePanel extends BaseSprite {
        ...
        protected init(): void {
            ...
            this.addPanelEventListener(com.events.EventType.STGAE_RESIZE, this.resize);
        ...
        */
        ...
        public close(isHideGuide: boolean = true): void {
            if (isHideGuide) {
                this.hideGuide();//清理一次引导
            }

            FairyUIManager.closePanel(this, this.panelInfo.canDispose);
        }
        ...
        public showMask(): void {
            ...
            if (
                this.panelInfo.panelType == com.enums.EnumPanel.TYPE_ALERT
                || this.panelInfo.panelType == com.enums.EnumPanel.TYPE_WINDOW2
        ...
        public get panelInfo(): PanelInfo {
            if (this._panelInfo == null) {
                let panelid: number = PanelRegister.getPanelId(this);
                this._panelInfo = PanelRegister.getPanel(panelid);
            }
         ...
         */
        public resize(): void {
            if (this.panelInfo.panelType == com.enums.EnumPanel.TYPE_BOTTOM) {
